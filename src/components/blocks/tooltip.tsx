...
export const Language = () => {
  ...
  return (
    <div className="flex flex-row items-center justify-center overflow-x-auto min-w-screen ">
      {Data.map((testimonial, idx) => (
        <div
          className="relative mx-3 w-16 h-16 group flex justify-center items-center"
...
export const DevOps = () => {
  ...
  return (
    <div className="flex space-x-3 flex-row items-center justify-center overflow-x-auto max-w-full">
      {Data.map((testimonial, idx) => (
        <div
...
export const Tools = () => {
  ...
  return (
    <div className="flex space-x-3 flex-row items-center justify-center  max-w-full">
      {Data.map((testimonial, idx) => (
        <div
          className="relative max-w-full  group flex justify-center items-center"
          key={testimonial.name}
